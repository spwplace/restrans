...
def build_model(args: argparse.Namespace, condition: str, tokenizer: StoryTokenizer):
    ...
    variant_options: dict[str, dict[str, Any]] = {
        ...
        "weighted_cosine": {
            "use_phase_stream": True,
            "use_resonance_bias": True,
            "resonance_kernel": "cosine_weighted",
        },
        "harmonic_cosine": {
            "use_phase_stream": True,
            "use_resonance_bias": True,
            "resonance_kernel": "harmonic_cosine",
            "kernel_rank": 4,
        },
        "rbf_kernel": {
            "use_phase_stream": True,
            "use_resonance_bias": True,
            "resonance_kernel": "rbf",
            "kernel_learnable_gamma": True,
        },
        "attention_kernel": {
            "use_phase_stream": True,
            "use_resonance_bias": True,
            "resonance_kernel": "attention",
        },
        "pair_mlp_kernel": {
            "use_phase_stream": True,
            "use_resonance_bias": True,
            "resonance_kernel": "pair_mlp",
            "kernel_rank": 64,
        },
        "relation_value_mix": {
            "use_phase_stream": True,
