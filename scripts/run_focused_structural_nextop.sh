...
DEVICE="${DEVICE:-mps}"
ROOT="${ROOT:-resonance/outputs/focused_structural_$(date -u +%Y_%m_%d_%H%M%S)}"
mkdir -p "$ROOT/logs"

# Full condition matrix from literature_medium_suite, but 1 seed for speed
...
# Natural language structural generalization
